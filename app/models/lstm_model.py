...
class LSTMModel:
    ...
    def fit(self, series, epochs=100, batch_size=16, validation_split=0.2):
        ...
        try:
            ...
            # Normalizar datos con manejo robusto
            data = self._normalize_data_robust(series.values.reshape(-1, 1))

            # Crear secuencias de entrenamiento
            X, y = self._create_sequences(data)

            # Reshape X para LSTM: [muestras, pasos_tiempo, características]
            ...
            logger.info("Modelo LSTM entrenado correctamente")
            return history
        except Exception as e:
